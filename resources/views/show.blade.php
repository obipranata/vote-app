    ...
    <div class="flex flex-1 px-4 py-6">
      ...
      <div class="mx-4 w-full">
        ...
        <div class="text-gray-600 mt-3">
          Lorem ipsum dolor sit amet consectetur. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dicta odio ducimus voluptates dolorum obcaecati adipisci sequi voluptate nostrum similique quasi eaque excepturi nobis veritatis at minus, rem odit. Nulla, quasi.
        </div>
  ...
  <div class="buttons-container flex items-center justify-between mt-6">
    <div class="flex items-center space-x-6 ml-6">
      ...
      <div x-data="{isOpen:false}" class="relative">
        ...
        @click="isOpen = !isOpen"
        type="button"
        class="flex items-center justify-center h-11 text-sm w-36 bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3"
        >
